...
export declare function submitEvent(req: AuthRequest, res: Response): Promise<void>;
export declare function approveEvent(req: AuthRequest, res: Response): Promise<void>;
export declare function rejectEvent(req: AuthRequest, res: Response): Promise<void>;
