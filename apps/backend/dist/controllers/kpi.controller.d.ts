...
export declare function getOverview(req: AuthRequest, res: Response): Response<any, Record<string, any>>;
...
export declare function getStudentKpi(req: Request, res: Response): void;
